...
public class MainActivity extends Activity {
    ...
    private void compute(Calculator.Operator operator) {
        ...
        double operandTwo;
        try {
            numberOne = getOperandText(mOperandOneEditText);
            numberTwo = getOperandText(mOperandTwoEditText);


            if (numberOne.equals("")) {
                operandOne = 0;
            } else {
                operandOne = Double.parseDouble(numberOne);
            }

            if (numberTwo.equals("")) {
                operandTwo = 0;
            } else {
                operandTwo = Double.parseDouble(numberTwo);
            }
